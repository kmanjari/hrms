...
(function (m, o) {
    var l = function (e, i) {
        var h = function (d, a) {
            if (!i.versionCheck || !i.versionCheck("1.10.1"))throw"DataTables Responsive requires DataTables 1.10.1 or newer";
            this.s = {dt: new i.Api(d), columns: []};
            this.s.dt.settings()[0].responsive || (a && "string" === typeof a.details && (a.details = {type: a.details}), this.c = e.extend(!0, {}, h.defaults, i.defaults.responsive, a), d.responsive = this, this._constructor())
        };
        h.prototype = {
            _constructor: function () {
                ...
                b = 0;
                for (f = g.length; b < f; b++)!0 === g[b] && (n += c[b].minWidth);
                a = a.table().container().offsetWidth - n;
                b = 0;
                for (f = g.length; b < f; b++)c[b].control ? a -= c[b].minWidth : "-" === g[b] && (g[b] = 0 > a - c[b].minWidth ? !1 : !0, a -= c[b].minWidth);
                a = !1;
                b = 0;
                for (f = c.length; b < f; b++)if (!c[b].control && !c[b].never && !g[b]) {
                    a = !0;
                    break
                }
                b = 0;
                for (f = c.length; b < f; b++)c[b].control && (g[b] = a);
                ...
                var d =
                    ...
                    if (k)if ("max-" === k) {
                        j = d._find(e).width;
                        e = 0;
                        for (k = a.length; e < k; e++)a[e].width <= j && b(f, a[e].name)
                    } else if ("min-" === k) {
                        j = d._find(e).width;
                        e = 0;
                        for (k = a.length; e < k; e++)a[e].width >= j && b(f, a[e].name)
                ...
                for (var a = this.c.breakpoints, c = 0, b = a.length; c < b; c++)if (a[c].name === d)return a[c]
            }, _resize: function () {
                for (var d = this.s.dt, a = e(m).width(), c = this.c.breakpoints, b = c[0].name, f = c.length - 1; 0 <= f; f--)if (a <= c[f].width) {
                    b = c[f].name;
                    break
                }
                var g = this._columnsVisiblity(b);
                d.columns().eq(0).each(function (a,
                                                 b) {
