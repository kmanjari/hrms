...
### Changes ###
 ...
 - In addition to "left" and "center", bars now recognize "right" as an
   alignment option. (patch by Genry Mayer, issue 520)
...
## Changes ##
 ...
 - Added support for segmented lines. (based on patch from Genry MacDonald)
...
## Bug fixes ##
 ...
 - Fixed a bug in dealing with data where min = max. (thanks to Genry
   Messinides)
